...
@Slf4j
@Component("Soap16ServerEventHandler")
public class Soap16ServerEventHandlerImpl extends AbstractRequestHandlerValidator implements ServerEventHandler, ServerEvents {
